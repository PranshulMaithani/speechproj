"""Upload combined wav2vec2 model to Hugging Face Hub."""
...
FILES = [
    ...
    "checkpoints_combined/wav2vec2_combined_best.pt",
    "checkpoints_combined/results.json",
    "checkpoints_combined/history.json",
]
    ...
    for i, file_path in enumerate(FILES, 1):
        ...
        try:
            api.upload_file(
                ...
                path_in_repo=f"combined/{p.name}",
                repo_id=REPO_NAME,
                repo_type="model",
            )
            print("done")
